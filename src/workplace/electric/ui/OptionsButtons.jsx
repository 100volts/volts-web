...
export default function OptionsButtons({ elmeter }) {

  const handleRedirect = (address) => {
    reportElectricData.set(address)
  };
  const goToSettings = (elMeter) => {
    selectedElectricMeter.set(elMeter);
  ...
  return (
    <>
      ...
      <Dialog className="flex"> 
          <DialogTrigger>
          <Button variant="outline" onClick={() => handleRedirect(elmeter.address)}>
        ...
        <Dialog className="flex">
          <DialogTrigger>
            <Button variant="outline" onClick={() => goToSettings(elmeter)}>
              <svg
                style={{ width: "25px" }}
                height="25px"
                viewBox="0 0 24 24"
          ...
          <DialogContent style={{ width: "50%", maxWidth: "100%" }}>
            <DialogHeader>
              ...
              <DialogDescription>Electric meter settings</DialogDescription>
            </DialogHeader>
            <SettingsOptions/>
          </DialogContent>
        </Dialog>
